...
public class ATM {
    ...
    public void deposit(BankCard card, double amount) {
        ...
        //todo: 2. Важно, не перезапишите баланс, а добавьтие к текущему балансу значение amount
        ...
        // Проследите за тем что бы при пополнении счета баланс не перезаписывался
