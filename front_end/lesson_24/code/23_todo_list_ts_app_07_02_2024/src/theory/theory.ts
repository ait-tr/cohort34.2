...
// npx create-react-app name_of_project     ->      создаёт react-приложение на javascript
// npx create-react-app name_of_project --template typescript    ->      создаёт react-приложение на typescript